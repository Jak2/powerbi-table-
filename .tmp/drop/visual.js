...
e);return new ml(b)};exports.render=function(a,b,c){if(!ol(b))throw Error(p(200));return rl(null,a,b,!1,c)};exports.unmountComponentAtNode=function(a){if(!ol(a))throw Error(p(40));return a._reactRootContainer?(Rk(function(){rl(null,null,a,!1,function(){a._reactRootContainer=null;a[uf]=null})}),!0):!1};__webpack_unused_export__=Qk;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   f: () => (/* binding */ HelloWorld)
/* harmony export */ });
...
const HelloWorld = ({ text }) => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, text);
};
// Example usage
function Component() {
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(890);
...
class Visual {
    ...
    formattingSettings;
    constructor(options) {
        this.formattingSettings = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .FormattingSettingsService */ .O();
        this.target = options.element;
        this.reactRoot = react__WEBPACK_IMPORTED_MODULE_1__.createElement(_component__WEBPACK_IMPORTED_MODULE_3__/* .HelloWorld */ .f, { text: "Hello, World!" });
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["opentable_DEBUG"] = opentable_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (opentable_DEBUG);

})();

opentable_DEBUG = __webpack_exports__;
/******/ })()
;
